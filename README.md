<h1 align="center">Iris: Mobile-first interactive portfolio and identity interface</h1>
...
### 1. Opening Ritual
A single-screen, tap-to-advance sequence that introduces intent and identity.
Scrolling is intentionally disabled at this stage to establish pacing and focus.
...
### 3. Observatory
A spatial, interactive environment where projects and ideas appear as constellations.
Users explore by scrolling, swiping, and touching elements rather than navigating menus.
